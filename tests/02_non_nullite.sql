SELECT * FROM (
    ...
    UNION ALL SELECT 'ecart_interquartile',  count(*) FROM mart_prix_m2_reference WHERE ecart_interquartile  IS NULL
...
-- evolution_pct est volontairement absente : nullable par construction (voir 06).